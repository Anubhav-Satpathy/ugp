...
from ..B.plot import color_argument_to_dict
...
def csv_to_list(csv):
    ...
    Returns:
        score: A list of note events where each note is specified as [start, duration, pitch, velocity, label]
    """
