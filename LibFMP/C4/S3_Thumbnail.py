...
def plot_seg_in_SP(ax, seg, S=None, Fs=1):
    ...
    if S is not None:
        ...
        ax.scatter(center/Fs, length/Fs, s=64, c=[1,1,1], zorder=9999)
        ax.scatter(center/Fs, length/Fs, s=16, c=[0,1,0], zorder=9999)
    length = seg[1] - seg[0] + 1
    center = seg[0] + length//2
    ax.scatter(center/Fs, length/Fs, s=64, c=[1,1,1], zorder=9999)
    ax.scatter(center/Fs, length/Fs, s=16, c=[0,0,1], zorder=9999)
